...
export const DISCORD_URL =
  import.meta.env.VITE_DISCORD_URL || 'https://discord.gg/jpGRXzu92K'

export const SITE_URL =
  import.meta.env.VITE_SITE_URL || 'https://www.ignatoken.com'

export const phoneNumber = '+421914704008'
