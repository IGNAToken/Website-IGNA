...
const PartOfTheChange = () => {
  ...
  return (
    <section className='flex flex-col items-center gap-12 px-4  mt-32'>
      ...
      <SectionTitle title={t('landing.partOfTheChange.title')} subtitle={t('landing.partOfTheChange.description')} />
      <div className='flex items-center flex-col md:flex-row gap-4 md:max-w-4/5'>
        ...
        <div className='flex flex-col gap-6 w-full md:w-1/2'>
          <div className='text-2xl font-bold text-primary'>{t('landing.pyrolisis.title')}</div>
