...
const Card = ({ title, description, icon, ctaComponent }: Props) => {
  return (
    <div className='flex flex-1 flex-col gap-4 border border-white/10 rounded-xl px-6 py-12 bg-background/50 backdrop-blur-sm items-center max-w-xs'>
