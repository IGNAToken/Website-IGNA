      ...
      <div className='container mx-auto flex gap-2 items-center justify-between'>
        ...
        <div className='flex gap-6 items-center'>
          ...
          <div className='flex gap-3 items-center'>
            ...
            <Button
              variant='outline'
              className='text-white rounded-4xl hover:bg-primary/15 hover:text-white transition-all duration-300 hidden md:flex'
      ...
      >
        <div className='flex flex-col justify-between h-full gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            <LanguageSelector variant='list' onLanguageChange={onClose} />
